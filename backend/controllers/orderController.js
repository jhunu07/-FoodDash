...
// Lazy initialization of Stripe - only when needed for online payments
const getStripe = () => {
...
const placeOrder = async (req, res) => {
  ...
  try {
    ...
    // For online payment, initialize Stripe and create checkout session
    try {
      ...
      res.status(500).json({ 
        success: false, 
        message: stripeError.message || "Payment gateway configuration error" 
      });
      return;
    }
